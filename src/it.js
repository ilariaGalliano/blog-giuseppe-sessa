  ...
  data() {
    return {
      it: {
        ...
        bioSecondPart:
          "Nello stesso anno si esibisce alla FIM di Milano e viene inoltre selezionato per partecipare alla finale del prestigioso concorso chitarristico 'New Sound of Acoustic Music', all'interno dell'Acoustic Guitar Village di Cremona. Ad ottobre del 2020, dopo l’esperienza nella convention dell’ADGPA tra Pieve di Soligo e Conegliano, dove accede dopo selezioni prima online, poi live, tra i 3 finalisti del concorso, affermandosi come uno dei migliori chitarristi acustici emergenti del panorama nazionale, pubblica il primo disco dal titolo “Orizzonte”, ricevendo notevoli apprezzamenti dal web e dalle varie testate giornalistiche di settore.",
        bioThirdPart:
