  ...
  data() {
    return {
      en: {
        ...
        my: "My",
        story: "Story.",
        song: "Listen to my track",
        album: "Listen to my new Album",
        oldAlbum: "Listen to my Album",
        spartito: "Download the sheet music",
        ...
        bioThirdPart:
          "After bringing his fingerstyle live show for several years, and sharing the stage and opening concerts with important guitarists and musicians such as: Jon Gomm, Peter Finger, Karlijn Langendijk, Pierangelo Mugavero, Finaz, Tommaso Primo, La Municipàl, he decided to put himself on the line and compare himself with other European guitarists, participating in 2022 in the Fingerstyle Collective Festival in Exeter (UK), organized by the important labels CandyRat and Fretmonkey, where he achieved 2nd place and the following year in the Warsaw Fingerstyle Festival, where he obtained another victory.",
